...
BOOL Hook_SetMenuCustom(HWND hWnd, HMENU hMenu) {
	...
	if (hMenu != hNB7MenuCheckChange) {
		...
		if (menu_count == 9) {
			...
			addMenuItem(hTarget, "武将エディタ", RESOURCE_MENU_ID_BUSHOUEDIT_ORIGINAL, ADDITIONAL_MENU_ID_BUSYOUEDIT_KAI);
			addMenuItem(hTarget, "ユニットエディタ", RESOURCE_MENU_ID_BUSHOUEDIT_ORIGINAL, ADDITIONAL_MENU_ID_UNITEDIT_KAI);
			addMenuItem(hTarget, "大名エディタ", RESOURCE_MENU_ID_BUSHOUEDIT_ORIGINAL, ADDITIONAL_MENU_ID_DAIMYOEDIT_KAI);
			addMenuItem(hTarget, "家宝エディタ", RESOURCE_MENU_ID_BUSHOUEDIT_ORIGINAL, ADDITIONAL_MENU_ID_KAHOUEDIT_KAI);
			addMenuItem(hTarget, "官位エディタ", RESOURCE_MENU_ID_BUSHOUEDIT_ORIGINAL, ADDITIONAL_MENU_ID_KANNIEDIT_KAI);
			addMenuItem(hTarget, "役職エディタ", RESOURCE_MENU_ID_BUSHOUEDIT_ORIGINAL, ADDITIONAL_MENU_ID_YAKUSYOKUEDIT_KAI);
			addMenuItem(hTarget, "年月エディタ", RESOURCE_MENU_ID_BUSHOUEDIT_ORIGINAL, ADDITIONAL_MENU_ID_NENNGETSUEDIT_KAI);
			addMenuItem(hTarget, "---", RESOURCE_MENU_ID_BUSHOUEDIT_ORIGINAL, NULL);
		}
	}
