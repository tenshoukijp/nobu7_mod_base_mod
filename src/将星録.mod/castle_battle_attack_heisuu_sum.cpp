...
struct âÄéíUŒ‚‘¤•”‘àî•ñ {
	...
	int unknown1;
	int •º”;     // ‚»‚Ì•”‘à‚ÌŒ»İ‚Ì•º”
	int •º”MAX;  // ‚»‚Ì•”‘à‚Ì•”‘à‚Ì•º”‚ÌMAX
	int unknown2; // 0 ‚ª“ü‚Á‚Ä‚¢‚é‚©H
	int	unknown3; // ‚»‚Ì•”‘à‚Ì•”‘à‚Ì•º”‚ÌMAX‚Æ“¯‚¶’l‚Ì‚æ‚¤‚È
	int p•s–¾ƒ|ƒCƒ“ƒ^1; // ‰½‚©‚Ìƒ|ƒCƒ“ƒ^‚Æv‚í‚ê‚é‚ª•s–¾B“¯‚¶•«‚È‚ç“¯‚¶ƒ|ƒCƒ“ƒ^‚©H
	int	unknown4; // •s–¾ 0‚ª‘½‚¢H
	int	unknown5; // •s–¾
	int	unknown6; // •s–¾
	int	pwŠö•«; // ‚»‚Ì•”‘à‚ğ—¦‚¢‚Ä‚¢‚é•«î•ñ‚Ö‚Ìƒ|ƒCƒ“ƒ^
	int unknown7; // 00 90 53 00 (0x539000)‚Æ‚¢‚¤•«î•ñ‚Ì”Ô•º‚ª“ü‚Á‚Ä‚¢‚é‚©H
	WORD unknown9; // •s–¾
};
