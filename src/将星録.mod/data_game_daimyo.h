...
struct NB7‘å–¼î•ñŒ^ {
	...
	int p•s–¾3; // •s–¾‚Èƒ|ƒCƒ“ƒ^
	int p•s–¾4; // •s–¾‚Èƒ|ƒCƒ“ƒ^
	int p•s–¾5; // •s–¾‚Èƒ|ƒCƒ“ƒ^
	BYTE ƒvƒŒƒCƒ„’S“–:4; // 0‚È‚ç’S“–‚Å‚Í‚È‚¢A1‚È‚ç’S“–
	BYTE _ƒvƒŒƒCƒ„’S“–•t‰Áî•ñ:4; // 1‚¾‚Á‚½‚è8‚¾‚Á‚½‚è•s–¾
	BYTE unknown17; // 
	int unknown18; // •s–¾
