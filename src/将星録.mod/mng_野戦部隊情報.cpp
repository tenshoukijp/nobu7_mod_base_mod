...
int UŒ‚•”‘àî•ñŒ^::s“®Ï‚İ::get()
{
	return nb7–ìíUŒ‚‘¤•”‘àî•ñ[•”‘à”z—ñIX].s“®Ï‚İ;
}
...
{
	return nb7–ìíç”õ‘¤•”‘àî•ñ[•”‘à”z—ñIX].•”‘à”Ô†;
}

int –hŒä•”‘àî•ñŒ^::•º”::get()
{
	return nb7–ìíç”õ‘¤•”‘àî•ñ[•”‘à”z—ñIX].•º”;
}

void –hŒä•”‘àî•ñŒ^::•º”::set(int value) {
	if (0 <= value && value <= nb7–ìíç”õ‘¤•”‘àî•ñ[•”‘à”z—ñIX].•º”MAX) {
		nb7–ìíç”õ‘¤•”‘àî•ñ[•”‘à”z—ñIX].•º” = value;
	}
	else {
		throw gcnew System::ArgumentOutOfRangeException("•º”‚ª•s³‚Å‚·B");
	}
...
{
	return nb7–ìíç”õ‘¤•”‘àî•ñ[•”‘à”z—ñIX].í•Ê;
}

int –hŒä•”‘àî•ñŒ^::s“®Ï‚İ::get()
{
	return nb7–ìíç”õ‘¤•”‘àî•ñ[•”‘à”z—ñIX].s“®Ï‚İ;
}

int –hŒä•”‘àî•ñŒ^::Šø•”‘à::get()
{
	return nb7–ìíç”õ‘¤•”‘àî•ñ[•”‘à”z—ñIX].Šø•”‘à;
}
