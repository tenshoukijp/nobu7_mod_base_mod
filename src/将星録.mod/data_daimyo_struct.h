...
struct NB7‘å–¼î•ñŒ^ {
	...
	BYTE “¯–¿c[64]; // ‚±‚Ì’l’¼Ú‘€ì‚¹‚¸Aset‘å–¼“¯–¿c‚Å‘€ì‚·‚é‚±‚Æ(‚Q‚Â‚Ì‘å–¼‚Ì’l‚ğ‘€ì‚·‚é•K—v‚ª‚ ‚é‚½‚ß)B“¯–¿ŠúŠÔ‚Ìc‚èŒ”Bindex‚Í‘å–¼”z—ñ‚ÌindexB‚±‚Ì’l‚Íu–{“–‚É¥ˆ÷ŠÖŒW‚Ì•P‚ª¶‘¶‚µ‚Ä‚¢‚évê‡‚ÉŒÀ‚èA‚»‚Ì‚Ü‚Ü”½‰f‚³‚êA‚»‚¤‚Å‚È‚¢ê‡‚ÍAƒQ[ƒ€ã‚Å‚Í”¼•ª‚Ì‚±‚Ì’l‚Ì”¼•ª(Ø‚èã‚°)‚Æ‚È‚é
	BYTE ¥ˆ÷[64]; // ‚±‚Ì’l’¼Ú‘€ì‚¹‚¸Aset‘å–¼¥ˆ÷‚Å‘€ì‚·‚é‚±‚Æ(‚Q‚Â‚Ì‘å–¼‚Ì’l‚ğ‘€ì‚·‚é•K—v‚ª‚ ‚é‚½‚ß)B¥ˆ÷—L‚è–³‚µB‚»‚ê‚¼‚ê‚Ìindex‚Í‘å–¼”z—ñ‚ÌindexB•P‚ª‘¶İ‚µ‚Ä‚¢‚È‚¢ê‡‚ÍA‚±‚Ìƒtƒ‰ƒO‚ğ‚P‚É—§‚Ä‚½‚Æ‚µ‚Ä‚àcŒ‚Ö‚ÌŒø—Í‚Í‚È‚¢B
	int ’©’ì; // 0`200
