...
static int testECX = 0; // š‚±‚ÌECX‚Í‚P`‚T•”‘àî•ñ‚Ö‚Ìƒ|ƒCƒ“ƒ^‚ğw‚µ‚Ä‚¢‚é‚ªA‚³‚ç‚É×‚©‚­‚ÄA
...
int pSSRExeJumpFromToOnSSRExeGetYasenHeisuu1 = 0x477E8A; // ŠÖ”‚Í‚±‚ÌƒAƒhƒŒƒX‚©‚çAOnSSRExeGetYasenHeisuu1‚Ö‚ÆƒWƒƒƒ“ƒv‚µ‚Ä‚­‚éB
int pSSRExeJumpCallFromToOnSSRExeGetYasenHeisuu1 = 0x47AE30; // Œ³X‚ ‚Á‚½ˆ—‚ÌCallæ
int pSSRExeReturnLblFromOnSSRExeGetYasenHeisuu1 = 0x477E8F; // ŠÖ”‚ªÅŒã‚Ü‚Å‚¢‚­‚ÆA‚±‚ÌÀsexe“à‚É’¼ÚƒWƒƒƒ“ƒv‚·‚é
...
__declspec(naked) void WINAPI OnSSRExeGetYasenHeisuu1() {
	...
	__asm {
		...
		call pSSRExeJumpCallFromToOnSSRExeGetYasenHeisuu1 // Œ³‚Ìˆ—
...
void WriteAsmJumperOnSSRExeGetYasenHeisuu1() {
	...
	memcpy(cmdOnSSRExeJumpFromGetYasenHeisuu1 + 1, &SubAddress, 4); // +1 ‚ÍE9‚ÌŸ‚©‚ç4ƒoƒCƒg•ª‘‚«Š·‚¦‚é‚©‚çB

	// \’z‚µ‚½ƒj[ƒ‚ƒjƒbƒN–½—ß‚ğÀsexe‚Ìƒƒ‚ƒŠ‚É‘‚«Š·‚¦‚é
	WriteProcessMemory(hCurrentProcess, (LPVOID)(pSSRExeJumpFromToOnSSRExeGetYasenHeisuu1), cmdOnSSRExeJumpFromGetYasenHeisuu1, 5, NULL); //5ƒoƒCƒg‚Ì‚İ‘‚«‚Ş
}
