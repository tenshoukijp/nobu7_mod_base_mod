...
std::string getUserCustomMovieFileName(System::String^ movie_filename) {
	...
	try {
		...
		System::Collections::Generic::Dictionary<System::String^, System::Object^>^ ret = InvokeUserMethod("onƒ€[ƒr[ƒtƒ@ƒCƒ‹–Ό—v‹", dic);
		...
		OutputDebugStream("onƒ€[ƒr[ƒtƒ@ƒCƒ‹–Ό—v‹‚ΕƒGƒ‰[");
	}
...
int pSSRExeReturnLblFromOnSSRExeMovieFileName = 0x419B02; // Φ”‚ªΕγ‚ά‚Ε‚Ά‚­‚ΖA‚±‚ΜTENSHOU.EXE“ΰ‚Ι’ΌΪƒWƒƒƒ“ƒv‚·‚ι
