...
int éî•ñŒ^::¤l::get()
{
	return nb7éî•ñ[é”z—ñIX].¤l;
}

void éî•ñŒ^::¤l::set(int value) {
	if (—ñ‹“::é::¤l::•sİ <= value && value <= —ñ‹“::é::¤l::‹“s¤l) {
		nb7éî•ñ[é”z—ñIX].¤l = value;
		if (value <= —ñ‹“::é::¤l::í’“¤l) {
			nb7éî•ñ[é”z—ñIX].¤l–K–â’† = 0;
		} else {
			nb7éî•ñ[é”z—ñIX].¤l–K–â’† = 1;
		}
	}
	else {
		throw gcnew System::ArgumentOutOfRangeException("¤l‚ª•s³‚Å‚·B");
	}
}

int éî•ñŒ^::éå•«”z—ñIX::get()
{
	int* BushouPtr = nb7éî•ñ[é”z—ñIX].péå;
...
int éî•ñŒ^::ˆÏ”Có‘Ô::get()
{
	return nb7éî•ñ[é”z—ñIX].ˆÏ”Có‘Ô;
}

void éî•ñŒ^::ˆÏ”Có‘Ô::set(int value) {
	if (—ñ‹“::é::ˆÏ”Có‘Ô::ˆÏ”C‚µ‚È‚¢ <= value && value <= —ñ‹“::é::ˆÏ”Có‘Ô::ˆÏ”C‚·‚é) {
		nb7éî•ñ[é”z—ñIX].ˆÏ”Có‘Ô = value;
		if (value == —ñ‹“::é::ˆÏ”Có‘Ô::ˆÏ”C‚µ‚È‚¢) {
			nb7éî•ñ[é”z—ñIX].ˆÏ”CUŒ‚ = 0;
			nb7éî•ñ[é”z—ñIX].pUŒ‚–Ú•Wé = (int*)UŒ‚–Ú•Wé‚È‚µ;
		}
	}
	else {
		throw gcnew System::ArgumentOutOfRangeException("ˆÏ”Có‘Ô‚ª•s³‚Å‚·B");
	}
}

int éî•ñŒ^::ˆÏ”CUŒ‚::get()
{
	return nb7éî•ñ[é”z—ñIX].ˆÏ”CUŒ‚;
}

void éî•ñŒ^::ˆÏ”CUŒ‚::set(int value) {
	if (—ñ‹“::é::ˆÏ”CUŒ‚::Ï‹ÉUŒ‚ <= value && value <= —ñ‹“::é::ˆÏ”CUŒ‚::UŒ‚‹Ö~) {
		nb7éî•ñ[é”z—ñIX].ˆÏ”CUŒ‚ = value;
	}
	else {
		throw gcnew System::ArgumentOutOfRangeException("ˆÏ”CUŒ‚‚ª•s³‚Å‚·B");
	}
}


int éî•ñŒ^::ˆÏ”CUŒ‚–Ú•Wé”z—ñIX::get()
{
	return getUŒ‚–Ú•WCastleId(é”z—ñIX);
}

void éî•ñŒ^::ˆÏ”CUŒ‚–Ú•Wé”z—ñIX::set(int value) {
