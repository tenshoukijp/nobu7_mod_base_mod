...
NB7ターン情報型 * const _nb7ターン情報 = (NB7ターン情報型*)(ターン情報アドレス);
NB7プレイヤターン城情報型* const _nb7ターン城情報 = (NB7プレイヤターン城情報型*)(プレイヤターン城情報アドレス);
...
NB7野戦部隊型 * const nb7野戦防御側部隊情報 = (NB7野戦部隊型*)(野戦防御側部隊アドレス);
NB7野戦部隊型 * const nb7野戦攻撃側部隊情報 = (NB7野戦部隊型*)(野戦攻撃側部隊アドレス);

NB7籠城戦防御側部隊情報型* const nb7籠城戦防御側部隊情報 = (NB7籠城戦防御側部隊情報型*)(籠城戦防御側部隊情報アドレス);
NB7籠城戦攻撃側部隊情報型* const nb7籠城戦攻撃側部隊情報 = (NB7籠城戦攻撃側部隊情報型*)(籠城戦攻撃側部隊情報アドレス);
