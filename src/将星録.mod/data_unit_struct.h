...
struct NB7ƒ†ƒjƒbƒgî•ñŒ^ {
	...
	int ƒ†ƒjƒbƒgŽí•Ê; // 0=ŒR¨ 1=ŒR‘D 2=—A‘— 3=ŠJ¤ 4=¤‹Æ 5=ŒšÝ 6=ŠÔŽÒ 7=”EŽÒ 8=ŽgŽÒ 9=ˆÚ“® 10=˜Ql
...
namespace ƒ†ƒjƒbƒgî•ñ {
	enum ƒ†ƒjƒbƒgŽí•Ê { ŒR¨ = 0, ŒR‘D = 1, —A‘— = 2, ŠJ¤ = 3, ¤‹Æ = 4, ŒšÝ = 5, ŠÔŽÒ = 6, ”EŽÒ = 7, ŽgŽÒ = 8, ˆÚ“® = 9, ˜Ql = 10 };
}
