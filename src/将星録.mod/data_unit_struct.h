...
struct NB7ƒ†ƒjƒbƒgî•ñŒ^ {
	...
	/* wŒ`ˆÊ’u
	  ...
	  „¤„Ÿ„¨„Ÿ„¨„Ÿ„£
	*/
	WORD ‘æ‚P•”‘à•ºŽí; // 0:‘«Œy 1:‹R”n 2:“S–C 3:‹R”n“S–C
	WORD ‘æ‚P•”‘à‚ÌwŒ`ˆÊ’u; //
	int ‘æ‚P•”‘à•º”; //
	WORD ‘æ‚Q•”‘à•ºŽí; // 0:‘«Œy 1:‹R”n 2:“S–C 3:‹R”n“S–C
	WORD ‘æ‚Q•”‘à‚ÌwŒ`ˆÊ’u; //
	int ‘æ‚Q•”‘à•º”; //
	WORD ‘æ‚R•”‘à•ºŽí; // 0:‘«Œy 1:‹R”n 2:“S–C 3:‹R”n“S–C
	WORD ‘æ‚R•”‘à‚ÌwŒ`ˆÊ’u; //
	int ‘æ‚R•”‘à•º”; //
	WORD ‘æ‚S•”‘à•ºŽí; // 0:‘«Œy 1:‹R”n 2:“S–C 3:‹R”n“S–C
	WORD ‘æ‚S•”‘à‚ÌwŒ`ˆÊ’u; //
	int ‘æ‚S•”‘à•º”; //
	WORD ‘æ‚T•”‘à•ºŽí; // 0:‘«Œy 1:‹R”n 2:“S–C 3:‹R”n“S–C
	WORD ‘æ‚T•”‘à‚ÌwŒ`ˆÊ’u; //
	int ‘æ‚T•”‘à•º”; //
