...
#define ŽŸ‚Ìƒ†ƒjƒbƒg–³‚µ     0x5390E0
...
struct NB7ƒ†ƒjƒbƒgî•ñŒ^ {
	...
	int* pŽwŠö•«; // •«‚Ö‚Ìƒ|ƒCƒ“ƒ^(•«î•ñ‚Ì”z—ñ‚ÌŠY“–•«‚Ìî•ñ‚ÌˆÊ’u‚ð’¼ÚŽw‚µ‚Ä‚¢‚é)B‚±‚±‚ª[B0 56 94]‚È‚ç‚ÎA‚»‚à‚»‚àƒ†ƒjƒbƒg‚ð’N‚à—¦‚¢‚Ä‚¢‚È‚¢B•«î•ñ’†‚Ì744l‚É“ü‚Á‚Ä‚¢‚é‚©‚Ç‚¤‚©‚Å”»’è‚·‚é‚Ì‚ª—Ç‚¢‚¾‚ë‚¤B
	int ‹à‘K;
	...
	BYTE unknown98[18];
	int* pŽŸ‚Ìƒ†ƒjƒbƒg; // ŽŸ‚Ìƒ†ƒjƒbƒg‚Ö‚Ìƒ|ƒCƒ“ƒ^Bƒ†ƒjƒbƒgî•ñ‚Ì”z—ñ‚ÌŠY“–ƒ†ƒjƒbƒg‚Ìî•ñ‚ÌˆÊ’u‚ð’¼ÚŽw‚µ‚Ä‚¢‚éB‚±‚ê‚ª[E0 90 53 00] = 0x5390E0‚È‚ç‚ÎAŽŸ‚Ìƒ†ƒjƒbƒg‚Í‘¶Ý‚µ‚È‚¢B
	int unknown10; // 0x00000000 ‚ª‘½‚¢
	/* wŒ`ˆÊ’u
	  „¡„Ÿ„¦„Ÿ„¦„Ÿ„¢
	  „ ‚Q„ ‚T„ ‚W„ 
	  „¥„Ÿ„©„Ÿ„©„Ÿ„§
...
int getŒR¨ƒ†ƒjƒbƒg•”‘àÅ‘å•º”(int iUnitID);
